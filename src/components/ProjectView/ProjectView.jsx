        ...
        <div className="ProjectView">
            ...
            <div className="ProjectView-header">
                <Fade timeout={1250} right>
                    <img className="ProjectView-Logo" src="./img/grayBackground.png" alt="project header" />
                </Fade>
            </div>
            ...
            <Fade timeout={1250} delay={500}>
                <img className="ProjectView-wireframes" src="./img/grayBackground.png" alt="project wireframes" />
            </Fade>
            ...
            <div className="ProjectView-topic">
                ...
                <Fade timeout={1250} right>
                    <img className="ProjectView-topicImg" src="./img/grayBackground.png" alt="project topic" />
                </Fade>
            </div>
            ...
            <Fade timeout={1250} delay={500} bottom>
                <div className="ProjectView-options">
                    <a className="ProjectView-git" href="./#">
                    ...
                    <a className="ProjectView-behance" href="./#">
                        <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="ProjectView-test" href="./#">Test Prototype</a>
                </div>
            </Fade>
